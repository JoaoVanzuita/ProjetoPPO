...
public class CadastrarFuncionarioDialog implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (funcionarioRecebido != null) {
            ...
            this.tfNomeCadastrarFuncionario.setText(this.funcionarioRecebido.getNome());
            this.tfEmailCadastrarFuncionario.setText(this.funcionarioRecebido.getEmail());
            this.endereco = this.funcionarioRecebido.getEndereco();
