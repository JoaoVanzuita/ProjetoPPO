...
public class CadastrarFornecedorDialog implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(fornecedorRecebido != null){
            ...
            this.tfNomeCadastrarFornecedor.setText(this.fornecedorRecebido.getNome());
            this.tfEmailCadastrarFornecedor.setText(this.fornecedorRecebido.getEmail());
            this.endereco = this.fornecedorRecebido.getEndereco();
