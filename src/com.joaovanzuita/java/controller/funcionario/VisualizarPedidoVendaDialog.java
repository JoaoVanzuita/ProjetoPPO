...
public class VisualizarPedidoVendaDialog implements Initializable {
    ...
    @FXML
    private ListView<ItemNFSaida> listViewItensNFEntrada;
    @FXML
    ...
    private void carregarItensNFSaida() {
        ...
        listViewItensNFEntrada.setItems(observableListItensNFSaida);
    ...
    private void atualizarValorTotal() {
        ...
        this.labelValorTotal.setText("R$ " + decimalFormat.format(valorTotal));
