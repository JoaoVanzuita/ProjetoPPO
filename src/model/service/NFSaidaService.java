...
public class NFSaidaService {
    ...
    public void cadastrarNFSaida (NFSaida nfSaida){
    ...
    //Evita que seja retirada uma quantidade de produtos maior que a disponível em estoque
    public boolean verificarQuantidade(ItemNFSaida itemNFSaida){

        return itemNFSaida.getQuantidade() > itemNFSaida.getProduto().getQuantidade();
    }
